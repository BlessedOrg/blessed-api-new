...
export class EntranceController {
  ...
  @RequireApiKey()
  @Get(":entranceId/entries")
  entries(@Req() req: RequestWithApiKey & EventValidate, @Param("entranceId") entranceId: string) {
    return this.entranceService.entries(entranceId);
  }
